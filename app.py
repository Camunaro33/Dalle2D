...
tabs = st.tabs(["Design checks & summary", "Deflection", "Moments & shears",
                 "Principal moments", "Rebar — As", "Rebar — layout", "Punching shear"])
...
# ============================================================================
# TAB 7: DESIGN CHECKS, CARBON ESTIMATE & DOWNLOADS ---------------------------
# ============================================================================
    ...
    if punching_applicable:
        if punching_ok:
            st.success(f"Punching shear (governing point load) — PASS: τf = {tau_f_MPa:.2f} MPa ≤ "
                       ...
                       "See the \"Punching shear\" tab for the full CSA A23.3 calculation.")
        else:
